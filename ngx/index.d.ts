...
export declare class FirebaseAuthentication extends IonicNativePlugin {
    ...
    /**
     *
     * @param verificationId Verification Id returned by the callback
     * @param smsCode SMS code sent to the user
     */
    linkWithEmail(verificationId: string, smsCode: string): Promise<any>;
    /**
